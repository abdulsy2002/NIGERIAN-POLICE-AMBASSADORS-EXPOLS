...
const ReunionSettingsSchema = new Schema<ReunionSettings>(
  {
...
export const ReunionSettingsModel = mongoose.models.ReunionSettings || mongoose.model<ReunionSettings>('ReunionSettings', ReunionSettingsSchema);
